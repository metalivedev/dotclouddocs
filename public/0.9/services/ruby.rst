...
If you haven't already, you should describe your dependencies
...
*config.ru* file (if one is not supplied with your application).

If you need to create such a file from scratch, check the `passenger Rack docs 
...
Rails applications will have multiple environments defined in the
