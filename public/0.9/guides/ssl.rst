...
(e.g. ``www.example.com``) to any application.
...
successfully to your Live or Enterprise dotCloud service, then you can purchase
...
directory containing those files, just run ``dotcloud push``).
...
The bill for your Live or Enterprise application will increase by the cost of
160MB of RAM. This monthly fee covers the cost of load-balancing and 
High Availability on the pair of edge servers configured with your 
SSL certificate.
