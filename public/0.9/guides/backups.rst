...
Download :download:`this backup script <backup.sh>` for your service.
...
.. note::
   The supplied backup script does not support SSH passwords. That's why
...
asked for a passphrase, don't supply one. You can also enable HTTPS
(it won't hurt)::
...
.. note::
   ...
   If you want your backups to occur at a fixed time, or at different frequencies,
